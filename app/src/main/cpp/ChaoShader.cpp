...
static GLuint InitShader(const char *code,GLint type) {
    ...
    if(sh == 0) {
        CHAOLOGE("glCreateShader %d failed!",type);
        return 0;
    }
    //加载shader
    glShaderSource(sh,
    ...
    if(status == 0) {
        CHAOLOGE("glCompileShader failed!");
        return 0;
    }
    CHAOLOGE("glCompileShader success!");
    return sh;
}
...
bool ChaoShader::Init(ChaoShaderType type) {
    ...
    CHAOLOGE("InitShader GL_FRAGMENT_SHADER success!");
    ...
    CHAOLOGE("glLinkProgram success!");
    /////////////////////////////////////////////////////////////
